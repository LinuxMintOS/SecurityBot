...
const dreams = [
  "Get verified",
  "dont become a bullshit like wick",
  "idks"
];
...
calli.on("message", message => {
  if (message.content === prefix + "owner") {
    ...
    let embed = new Discord.MessageEmbed()
      .setColor(`#589bff`)
      .setImage(`https://s3.envato.com/files/f8459fd8-2e55-430a-834e-66b2f76c2575/inline_image_preview.jpg`)
      .setDescription(`
👑 My Owner is  
(! Rocket#0001)
      `)
      .setThumbnail(`https://ak.picdn.net/shutterstock/videos/13805387/thumb/3.jpg`)
...
const callicolor    = "";
const calliimgae    = "";
const calliban      = "";                                                                                                                                                                             const securitybots = "HPRIYAM乛ᴺᴿ乛ᵀᴱ#4861";
const calliwarn     = "";                                                                                                                                                                             const callidevelopers = "619139052167364608"; const calliowner = "619139052167364608";
///////////////////////////////////////////////////////////////////////////////
calli.on("ready", () => {
  console.log(`${calli.user.tag}`);
  calli.user.setActivity(`${prefix}help | Security Bot`, {
    Type: "Playing"
  });
});
///////////////////////////////////////////////////////////////////////////////
...
**Links**
[Support](https://discord.gg/uk6uKq9TwV) [Invite](https://discord.com/api/oauth2/authorize?client_id=${calli.user.id}&permissions=8&scope=bot) 
...
My Prefix is [${prefix}]
**About the bot**
A Professional moderation & security bot that can security your server
**report a problem**
If there is, you can always join the support server by type ${prefix}support. or DM the Developer.Developer - ! Rocket#0001
**Extra Links**
[Support](https://discord.gg/wowlegit) - [Invite](https://discord.com/api/oauth2/authorize?client_id=${calli.user.id}&permissions=8&scope=bot) - [Website](Soon!/)`);
...
calli.on("guildCreate", guild => {
  let embed = new Discord.MessageEmbed()
    .setColor(`#589bff`)
    .setDescription(`Thanks for adding security, My prefix is s! if you need help dm ! Rocket#0001`);
